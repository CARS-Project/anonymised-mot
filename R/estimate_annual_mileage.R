...
test_data_wide <- readRDS(paste0(path,"mileage_wide_2005_2021.Rds"))
...
car_data <- readRDS(paste0(path,"car_data_2005_2021.Rds"))
...
test_mileage$first_year <- names(test_mileage[2:18])[max.col(!is.na(test_mileage[2:18]), "first")]
test_mileage$last_year <- names(test_mileage[2:18])[max.col(!is.na(test_mileage[2:18]), "last")]
...
test_mileage <- test_mileage[,c("vehicle_id",paste0("test_mileage_",2004:2021))]
test_mileage <- pivot_longer(test_mileage, 
                             cols = test_mileage_2004:test_mileage_2021,
                             names_to = "year",
...
#clear up memory
saveRDS(test_postcode,paste0(path,"test_postcode_wide_2005_2021.Rds"))
...
saveRDS(test_mileage_wide,paste0(path,"test_mileage_wide_2005_2021_with_neg.Rds"))
...
test_mileage_wide = test_mileage_wide[,c("vehicle_id",paste0("km_",2006:2021))]

test_mileage_wide[2:17] <- lapply(test_mileage_wide[2:17], as.integer)

saveRDS(test_mileage_wide,paste0(path,"annual_km_2006_2021.Rds"))
